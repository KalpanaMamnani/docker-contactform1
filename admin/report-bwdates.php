                  ...
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT FullName,PhoneNumber,PostingDate,id,Is_Read from tblcontactdata where date(PostingDate) between ? and ?";
                        $query = mysqli_prepare($con, $sql);
                        mysqli_stmt_bind_param($query, "ss", $fdate, $tdate);
