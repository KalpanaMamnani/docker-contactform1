                    ...
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        if ($srhby == "name"):
                          ...
                          $sql = "SELECT FullName,PhoneNumber,PostingDate,id,Is_Read from tblcontactdata where FullName like ? ";
                        endif;

                        // Search by phone numner
                        if ($srhby == 'phone'):

                          $sql = "SELECT FullName,PhoneNumber,PostingDate,id,Is_Read from tblcontactdata where PhoneNumber like ? ";

                        endif;

                        // Search by email
                        if ($srhby == 'email'):
                          $sql = "SELECT FullName,PhoneNumber,PostingDate,id,Is_Read from tblcontactdata where EmailId like ? ";
                        endif;

                        $query = mysqli_prepare($con, $sql);
                        mysqli_stmt_bind_param($query, "s", $srhkey);
